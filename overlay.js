...
(function () {
  ...
  const PANEL_W_DEF = 324;   // 432 × 75% = 324px (-25%)
  ...
  const STORE_W     = 'dc_overlay_width_v2'; // เปลี่ยน key เพื่อ reset ค่าที่บันทึกไว้
  ...
  // ไม่ restore state — overlay เริ่มปิดเสมอ เพื่อไม่ให้ trigger auth อัตโนมัติ
  // setOpen(true) จะถูกเรียกเฉพาะเมื่อ user คลิก FAB หรือปุ่ม D Tool
